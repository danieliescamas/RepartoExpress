<%-- 
    Document   : contratos
    Created on : 19-abr-2021, 21:01:47
    Author     : daniel
--%>
            ...
            <div class="container mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h1 class="text-center">${trabajador.nombre}, aquí tienes una lista de todos tus contratos...</h1>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8 offset-md-2 columnas">
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <c:forEach var="contrato" items="${gestion.ordenarContratos(trabajador.contratos)}">
