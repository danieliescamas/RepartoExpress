<%-- 
    Document   : vehiculos
    Created on : 15-abr-2021, 12:59:27
    Author     : daniel
--%>
...
<html>
    <head>
        ...
        <h2 class="text-center mt-4">
            ${trabajador.nombre}, estos son tus vehículos... 
        </h2>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <form id="eliminar${vehiculo.id}" action="VehiculoParticular" method="GET">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="VehiculoParticular">
        ...
        <script>
            ...
            function enviarFormulario(id) {
                ...
                //if (confirm("Estás seguro que quieres eliminar el vehiculo?")) {
                  //  document.getElementById("eliminar" + id).submit();
                }
